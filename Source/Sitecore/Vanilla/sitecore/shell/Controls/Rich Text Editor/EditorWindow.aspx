...
<title>Sitecore</title>
  ...
  <script type="text/javascript">
    ...
    function scClientClose() {
      ...
      Element.remove(Element.select(window.top.document, '#ModalOverlayRTE')[0]);
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server">
      <ContentTemplate>
        ...
        <telerik:RadWindowManager ShowContentDuringLoad="false" VisibleStatusbar="false" runat="server" >
          <Windows>
            <telerik:RadWindow ID="MainWindow" Behaviors="Resize,Move,Close,Maximize" runat="server" Width="800" Height="600" ReloadOnShow="false" Skin="Default" OnClientBeforeClose="scClientClose" />
          </Windows>
