...
scBrowser.prototype.showModalDialog = function(url, arguments, features, request) {
  this.insertAdjacentHTML(window.top.document.body, 'afterbegin', '<div id="ModalOverlay" style="position: absolute; left: 0px; top: 0px; width: 100%; height: 100%; z-index: 10002; background-color: rgb(170, 170, 170); filter:alpha(opacity=50); opacity: 0.5;"></div>');
